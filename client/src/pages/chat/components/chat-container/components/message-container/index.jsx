...
const renderChannelMessages = (message) => {
  ...
  <div className="flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:w-[65w] lg:w-[70vw] xl:w-[80vw] w-full">
   ...
   <div ref={scrollRef} />
    {
  showImage && (<div className="fixed z-[1000] top-0 left-0 h-[100vh] w-[100vw] backdrop-blur-lg flex-col">
    <div>
        <img
          src={`${HOST}/${imageURL}`}
     ...
     <div className="flex gap-5 fixed top-0 mt-5">
        <button
          className="bg-black/20 p-3 text-2xl rounded-full hover:bg-black/50 cursor-pointer transition-all duration-300"  onClick={() => downloadFile(imageURL)}
          >
